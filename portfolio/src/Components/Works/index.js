  ...
  return (
    <Screen className="detailWrapper">
      ...
      <div
        className="workBg"
        style={{
          backgroundImage: `url(${current ? current.logo : currentMemo.logo})`,
        }}
      ></div>
      <MediaCard
        ...
        description={
          current ? current.descriptionFull : currentMemo.descriptionFull
        }
...
export const DetailHeader = ({ backRoute, routeName, right }) => {
  ...
  return (
    ...
    >
      <Link
        to={backRoute}
        transition={right ? 'glideIn-left' : 'glideOut-right'}
      >
        <Toolbar>
          <IconButton
            edge="start"
